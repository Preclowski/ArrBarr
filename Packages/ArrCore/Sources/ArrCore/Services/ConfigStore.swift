...
public final class ConfigStore: ObservableObject {
    ...
    @Published public var transmission: ServiceConfig
    @Published public var rtorrent: ServiceConfig
    @Published public var deluge: ServiceConfig
    @Published public var foregroundInterval: TimeInterval
    @Published public var backgroundInterval: TimeInterval
    ...
    @Published public var showTonight: Bool
    @Published public var showNeedsYou: Bool
    @Published public var showIndexerIssues: Bool
    @Published public var collapsedArrs: Set<String>
    @Published public var tonightHours: Int
